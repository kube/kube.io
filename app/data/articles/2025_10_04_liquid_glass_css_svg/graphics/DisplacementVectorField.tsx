  ...
  return (
    ...
    >
      <svg
        ...
        className="w-full h-[clamp(200px,80vw,500px)] contain-layout contain-style contain-paint [content-visibility:auto] [contain-intrinsic-size:clamp(200px,80vw,500px)]"
