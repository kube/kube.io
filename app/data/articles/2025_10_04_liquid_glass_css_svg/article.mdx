...
- Circle shapes only in this article. Extending to other shapes requires preliminary calculations.

  Circles also let us form rounded rectangles by stretching the middle along the x or y axis.
