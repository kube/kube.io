...
date: 2025-10-04
published: true
image: https://kube.io/blog/liquid-glass-css-svg/og-image.png
---
...
What Apple seems to call "specular" in Liquid Glass is a border around the object, which opacity is defined by the dot product (or alignment) of the normal to border and an arbitrary vector.
