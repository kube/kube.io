...
Our glass surface is described by a mathematical function that defines how thick the glass is at any point from its edge to its center. This **surface function** takes a value between 0 (at the outer edge) and 1 (at the center) and returns the height of the glass at that point.
