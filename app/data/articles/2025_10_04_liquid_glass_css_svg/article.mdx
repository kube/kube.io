...
<div className="grid grid-cols-[auto_1fr] gap-x-4 sm:gap-x-6 gap-y-8 items-start w-full mb-12">
...
<div className="min-w-0 h-full flex flex-col justify-center">
  ...
  <div className="text-sm opacity-80 mt-1">
    Simple circular arc → a spherical dome. Easier than the squircle, but the
    transition to the flat interior is harsher, producing sharper refraction
    edges—more noticeable when the shape is stretched away from a true circle.
  </div>
</div>
...
<div className="min-w-0 h-full flex flex-col justify-center">
  ...
  <div className="text-sm opacity-80 mt-1">
  Uses the [Squircle](https://en.wikipedia.org/wiki/Squircle) Apple favors: a
...
<div className="min-w-0 h-full flex flex-col justify-center">
  ...
  <div className="text-sm opacity-80 mt-1">
    The concave surface is the complement of the convex function, creating a
    bowl-like depression. This surface causes light rays to diverge outward,
    displacing them beyond the glass boundaries.
  </div>
</div>
...
<div className="min-w-0 h-full flex flex-col justify-center">
  ...
  <div className="text-sm opacity-80 mt-1">
  Blends convex and concave via [Smootherstep](https://en.wikipedia.org/wiki/Smoothstep): raised rim, shallow center dip. The $+0.5$ concave offset reduces depth, limiting outward refraction.
