...
export const cv = {
  ...
  cursus: [
    ...
    {
      date: { from: { year: 2005 }, to: { year: 2009 } },
  ...
  work: [
    ...
    {
      date: { from: { month: 11, year: 2023 }, to: { month: 11, year: 2024 } },
      title: "Weabea",
    ...
    {
      date: { from: { month: 3, year: 2021 }, to: { month: 3, year: 2023 } },
      title: "TheFork",
      place: "France",
      subtitle: "Software Engineer",
    ...
    {
      date: { from: { month: 10, year: 2019 }, to: { month: 8, year: 2020 } },
      title: "Tinyclues",
      place: "Paris",
      subtitle: "Software Engineer",
    ...
    {
      date: { from: { month: 4, year: 2019 }, to: { month: 8, year: 2019 } },
      title: "Contentsquare",
      place: "Paris",
      subtitle: "Software Engineer",
    ...
    {
      date: { from: { month: 12, year: 2018 }, to: { month: 2, year: 2019 } },
      title: "Iziwork",
      place: "Paris",
    ...
    {
      date: { from: { month: 8, year: 2017 }, to: { month: 2, year: 2018 } },
      title: "Teads",
      place: "Montpellier",
    ...
    {
      date: { from: { month: 1, year: 2016 }, to: { month: 5, year: 2016 } },
      title: "DotID",
    ...
    {
      date: { from: { month: 9, year: 2014 }, to: { month: 12, year: 2014 } },
      title: "PopChef",
      place: "Paris",
    ...
    {
      date: { from: { month: 7, year: 2008 }, to: { month: 8, year: 2008 } },
      title: "XSalto",
      place: "Digne",
